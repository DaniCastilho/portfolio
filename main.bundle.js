...
var AppHeaderComponent = (function () {
    function AppHeaderComponent() {
        this.text = '{ Dani Castilho - Web Developer }';
        this.el = document.getElementsByClassName('app-header__title');
        this.char = '';
        this.writer = '';
        this.next = '';
    }
    AppHeaderComponent.prototype.typeWriter = function (text, el) {
        var _this = this;
        this.char = text.split('').reverse();
        this.writer = setInterval(function () {
            if (!_this.char.length)
                return clearInterval(_this.writer);
            _this.next = _this.char.pop();
            el[0].innerHTML += '<span>' + _this.next + '</span>';
        }, 120);
    };
